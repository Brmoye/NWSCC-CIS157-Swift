...
let totalTime = brushTeeth + chooseClothes + finishHomework + fixLunch
...
let haveToDo = brushTeeth + chooseClothes
let likeToDo = fixLunch + finishHomework
...
*/
let newTotalTime = brushTeeth + chooseClothes + fixLunch + finishHomework
