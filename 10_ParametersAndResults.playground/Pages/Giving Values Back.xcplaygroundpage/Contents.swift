...
var favoriteMessage = makeFavorite(categoryOfThing: "food", favorite: "cookies")
print(favoriteMessage)
favoriteMessage = makeFavorite(categoryOfThing: "movie", favorite: "No Time To Die")
print(favoriteMessage)
print(makeFavorite(categoryOfThing: "school subject", favorite: "Swift"))
print(makeFavorite(categoryOfThing: "band", favorite: "ACDC"))
...
let favoriteFoodMessage = makeFavorite(categoryOfThing: "food", favorite: "cookies")
let favoriteVideoStar = makeFavorite(categoryOfThing: "video star", favorite: "Casey Neistat")

print("Hello, my name is Euna. \(favoriteFoodMessage) \(favoriteVideoStar) ...")
