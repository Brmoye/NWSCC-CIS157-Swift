...
let impossibleBeliefs = impossibleBeliefsCount(pigsFlying: 2, frogsBecomingPrinces: 1, multipleLightningStrikes: 4)

impossibleThingsPhrase(numberOfImpossibleThings: impossibleBeliefs, meal: "mealtime")
