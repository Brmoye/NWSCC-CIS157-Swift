...
songTitles.append("Whatever It Takes")
songTitles.append("Hooked On A Feeling")
songTitles.append("Firework")
songTitles.append("Give You Blue")
 ...
 */
let enthusiastSingerList = ["Country Road", "Old Town Road", "Wagonwheel"]
songTitles = enthusiastSingerList
...
for songTitle in songTitles {
    print("Hey, next singer, it's your turn to sing \"\(songTitle)\"")
}
