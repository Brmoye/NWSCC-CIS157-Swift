...
if yesVotes > noVotes {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to change the mascot passed!")
}
else if noVotes > yesVotes {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to change the mascot failed!")
}
else {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to change the mascot was a tie!")
}
...
if yesVotes > noVotes {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to have more poll options passed!")
}
else if noVotes > yesVotes {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to have more poll options failed!")
}
else {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to have more poll options was a tie!")
}
...
if yesVotes > noVotes {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to install a coffee vending machine passed!")
}
else if noVotes > yesVotes {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to install a coffee vending machine failed!")
}
else {
    print("With \(yesVotes) yes votes and \(noVotes) no votes, the vote to install a coffee vending machine was a tie!")
}
/*:
 ### Extension:
