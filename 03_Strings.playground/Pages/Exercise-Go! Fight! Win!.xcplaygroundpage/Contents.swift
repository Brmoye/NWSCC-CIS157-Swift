...
let schoolName = "Muscle Shoals Trojans"
let refrain = "We love you with your mountain so high, \(schoolName)! You will live on in our wallets, oh \(schoolName)!"

let song = "\(refrain)\n\(refrain)\nYes, \(refrain), oh \(schoolName)"
