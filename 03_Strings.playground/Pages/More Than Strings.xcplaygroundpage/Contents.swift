...
let name = "Horace"
let number = "200"
let adjective = "racing"
let noun = "drone"
let place = "store"
let positiveEmotion = "elated"
let negativeEmotion = "dejected"

let myVersionOfStory = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). The were all out of \(noun)!"
